...
urlpatterns = patterns('',
    ...
    url(r'^(?P<newsletter_id>\d+)/preview/iframe/$', views.iframe_preview, 
        name="newsletter.preview.iframe"),
    url(r'^([a-z0-9]{3,})/(\d+)/$', views.person_newsletter,
       name="newsletter.person"),
)